...
#define MKA_CFG_ASSERT_ACTION()             (void)1U/* empty */
...
#define MKA_CFG_EVENT_ACTION(bus, event)    1U /* empty */

/* MKA compile-time logging level */
#define MKA_CFG_LOGGING_LEVEL               MKA_LOGLEVEL_DISABLED

/* MKA logging verbosity level (only applicable for debug logging level) */
#define MKA_CFG_VERBOSITY                   0U
